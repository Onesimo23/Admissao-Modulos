...
<head>
    ...
    <title>Relatório de Candidatos por Província</title>
    ...
    <style type="text/css">
        ...
        .province-table tr:nth-child(even) {
    ...
    <div class="report-container">
        <div class="report-header">
            ...
            <div class="report-header-content">
                <h1>Relatório de Candidatos por Província</h1>
        ...
        <div class="report-content">
            <table class="province-table">
                <thead>
                    <tr>
                        <th>Província</th>
                        <th class="text-right">Total de Candidatos</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($report as $province)
                    <tr>
                        <td>{{ $province['local_exam'] }}</td>
                        <td class="text-right">{{ $province['total_candidates'] }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="total-summary">
                <p>Total de Províncias: {{ count($report) }}</p>
                <p>Total de Candidatos: {{ 
                    array_reduce($report->toArray(), function($carry, $province) {
                        return $carry + $province['total_candidates'];
                    }, 0) 
                }}</p>
            </div>
        </div>

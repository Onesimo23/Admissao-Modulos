                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        ...
                        @php
							...
							, clique em "<span class="text-blue-800"><b>Editar Dados</b></span>". <b>Antes de efectuar o pagamento</b>, Poderá actualizar os dados da candidatura';
							$cor = 'red';
                            ...
                            <div class="flex flex-col space-y-4">
                                ...
                                <div class="w-full">
                                    <div class="bg-gray-100 border-l-4 border-gray-600 text-gray-700 p-4" role="alert">
                                        ...
                                        <p class="mt-2 mb-2">
											 Caro Candidato ao Regime <b>EAD, POS-LABORAL ou SEMI-PRESENCIAL</b>, após a confirmação do pagamento , 									
											 submeta os seguintes documentos:
										</p>
										...
										<p class="mt-2 mb-2">
											<b>NOTA:</b> submeta no <b>formato PDF (único ficheiro)</b> com o seguinte nome: 
											<b>NrCandidato_Nome( ex.10001_Antonio_Pedro)</b>
										</p>
